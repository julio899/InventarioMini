                            <div class="panel-body">
                                <div class="list-group">
                                    ...
                                    <a href="javascript:;" data-toggle="modal" data-target="#modal_consultar_mes" class="list-group-item <?php if($this->session->userdata('pagina')=='fac_compras_mes_especifico'){ echo 'active';} ?>"><i class="fa fa-question-circle">  </i> Consultar Mes Especifico</a>
